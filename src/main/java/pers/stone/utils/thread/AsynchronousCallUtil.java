...
public class AsynchronousCallUtil {
    ...
    private void init() {
        ...
        if (threadPool == null) {
            threadPool = new ThreadPoolExecutor(0, poolsize, 1000L, TimeUnit.MILLISECONDS,
                    new ArrayBlockingQueue<Runnable>(queueSize), new TaskThreadFactory(),
     ...
     * @param args 原方法的参数，支持多个参数， 要调用的方法参数逗号分隔原样填写即可
     * @throws Exception
     */
    public void submit(Object instance, String methName, Object... args) throws Exception {
